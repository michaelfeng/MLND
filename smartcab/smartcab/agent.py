...
def run():
    ...
    sim = Simulator(env, update_delay=0.0, log_metrics=True, optimized=True, display=True)
    ...
    # Set a low tolerance in order to make the reliability as high as possible
    # But 0.001 may be too low and time cost
    # Value about 0.05 would be better for performance and safety\reliability balance
